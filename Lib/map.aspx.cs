                    ...
                    foreach (DataRow row in ds.Tables[0].Rows)
                    {
                        if (X != row["坐標X"].ToString() | Y != row["坐標Y"].ToString())
                        {
                            Msg.Text = Msg.Text + "<img tagName='" + X + "," + Y + "' src='../images/green.gif"
                                ...
                                + (13 * int.Parse(X) + 28).ToString() + ";top:" + (14 * int.Parse(Y) + 2).ToString()
        ...
        if (!IsPostBack)
        {
            ...
            if (PointerNo != null & PointerNo !="")
            {
                ...
                if (dr.Read())
                {
                    ...
                    if (IO == "I")
                    {
                        pos1.Style.Value = "z-index:2;position:absolute;left:" + (13 * X + 28).ToString() + ";top:" + (Y * 14 + 2).ToString();                        
                    }
                    else
                    {
                        pos2.Style.Value = "z-index:2;position:absolute;left:" + (13 * X + 28).ToString() + ";top:" + (Y * 14 + 2).ToString();
                    }
                }
