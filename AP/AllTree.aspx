<%@ Page Title="整合迴路" Language="C#" MasterPageFile="~/IDMS/MasterPage.master" AutoEventWireup="true"
    CodeFile="AllTree.aspx.cs" Inherits="AP_AllTree" MaintainScrollPositionOnPostback="true"
    Debug="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="lblFunc" runat="server" Font-Size="Large" ForeColor="Red" Text="請先選取某節點當查詢條件後按查詢，以產生可能連帶受影響之下游，再選取其它(根)節點並展開，或產生報表，以查看異常節點(正常節點不顯示)"></asp:Label>    
    <br /><br />
    <table border="1" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td width="25%">
                <asp:DropDownList ID="SelPowerLimit" runat="server" ForeColor="#009933" >
                        <asp:ListItem Value="Y">限縮</asp:ListItem>
                        <asp:ListItem Value="N">不限</asp:ListItem>
                </asp:DropDownList>&nbsp;&nbsp;
                <asp:LinkButton ID="BtnPowerOpen" runat="server" Font-Size="Small" Text="展開" ToolTip="自所選節點展開全部樹狀結構以檢視異常電力節點" OnClick="BtnPowerOpen_Click" />&nbsp;&nbsp;
                <asp:LinkButton ID="BtnPowerClose" runat="server" Font-Size="Small" Text="閉合" ToolTip="閉合接電迴路樹狀結構至所選節點" OnClick="BtnPowerClose_Click" />
            </td>

            <td width="25%">
                <asp:DropDownList ID="SelNetLimit" runat="server" ForeColor="#009933" >
                        <asp:ListItem Value="Y">限縮</asp:ListItem>
                        <asp:ListItem Value="N">不限</asp:ListItem>
                        <asp:ListItem Value="">不含</asp:ListItem>
                </asp:DropDownList>&nbsp;&nbsp;
                <asp:LinkButton ID="BtnNetOpen" runat="server" Font-Size="Small" Text="展開" ToolTip="自所選節點展開全部樹狀結構以檢視異常網路節點(正常網路節點不顯示)" OnClick="BtnNetOpen_Click" />&nbsp;&nbsp;
                <asp:LinkButton ID="BtnNetClose" runat="server" Font-Size="Small" Text="閉合" ToolTip="閉合接網迴路樹狀結構至所選節點" OnClick="BtnNetClose_Click" />
            </td>

            <td width="25%">
                <asp:DropDownList ID="SelApLimit" runat="server" ForeColor="#009933" >
                        <asp:ListItem Value="Y">限縮</asp:ListItem>
                        <asp:ListItem Value="N">不限</asp:ListItem>
                        <asp:ListItem Value="" Selected="True">上線</asp:ListItem>
                </asp:DropDownList>&nbsp;&nbsp;
                <asp:LinkButton ID="BtnApOpen" runat="server" Font-Size="Small" Text="展開" ToolTip="自所選節點展開全部樹狀結構以檢視異常主機節點(正常主機節點不顯示)" OnClick="BtnApOpen_Click" />&nbsp;&nbsp;
                <asp:LinkButton ID="BtnApClose" runat="server" Font-Size="Small" Text="閉合" ToolTip="閉合作業主機樹狀結構至所選節點" OnClick="BtnApClose_Click" />
            </td>

            <td width="25%">
                <asp:DropDownList ID="SelSysLimit" runat="server" ForeColor="#009933" >
                        <asp:ListItem Value="Y">限縮</asp:ListItem>
                        <asp:ListItem Value="N">不限</asp:ListItem>
                        <asp:ListItem Value="">不含</asp:ListItem>
                </asp:DropDownList>&nbsp;&nbsp;
                <asp:LinkButton ID="BtnSysOpen" runat="server" Font-Size="Small" Text="展開" ToolTip="自所選節點展開全部樹狀結構以檢視異常系統節點(正常系統節點不顯示)" OnClick="BtnSysOpen_Click" />&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td valign="top" width="25%">
                <asp:TreeView ID="TreeViewAp" runat="server" ImageSet="XPFileExplorer" NodeWrap="True"
                    ...
                    <HoverNodeStyle Font-Underline="True" ForeColor="#6666AA" />
                    <Nodes>
                        <asp:TreeNode PopulateOnDemand="True" SelectAction="SelectExpand" Text="<font color='blue' size='large'><b>作業主機</b></font>" Value="0" ToolTip="資訊系統請對照資產清冊"></asp:TreeNode>
                    </Nodes>
                    <NodeStyle Font-Names="Tahoma" Font-Size="10pt" ForeColor="Black" HorizontalPadding="2px"
                        NodeSpacing="0px" VerticalPadding="2px" />
                    <ParentNodeStyle Font-Bold="False" />
    ...
    <br />
    <div align="right">        
        <asp:Button ID="BtnSearch" runat="server" Font-Size="Large" Font-Bold="true" ForeColor="Red" Text="　查　詢　" ToolTip="依選取的節點作為查詢條件往下查詢整合迴路，以及產生異常節點(正常節點不產生)" OnClick="BtnSearch_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        
        ...
        <asp:CheckBox ID="ChkPower" runat="server" Text="列出電力" Checked="true" Font-Size="Small" ToolTip="報表是否需列出電力設備之資料" />
        <asp:CheckBox ID="ChkNet" runat="server" Text="列出網路" Checked="true" Font-Size="Small" ToolTip="報表是否需列出網路設備之資料" />
        <asp:CheckBox ID="ChkOnLine" runat="server" Text="僅已上線" Checked="true" Font-Size="Small" ToolTip="報表是否僅列出已上線之資料" />
        <asp:Button ID="BtnReport" runat="server" Font-Size="Large" Text="　報　表　" ToolTip="列出所有下游受影響節點之清單，分為查詢條件、實體設備、作業主機、系統資源等四大區塊" OnClick="BtnReport_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BtnMap" runat="server" Font-Size="Large" OnClick="BtnMap_Click" Text="設備分佈圖" ToolTip="在機房平面圖點出所有下游受影響節點設備" />
    </div>      
</asp:Content>
