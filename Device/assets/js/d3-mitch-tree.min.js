        ...
        function(t, n, e) {
            ...
            V.prototype = $.prototype = {
                ...
                select: function(t) {
                    ...
                    for (
                        var n = this._groups, e = n.length, i = new Array(e), r = 0; r < e;
                        ++r
                    )
                        for (
                            var u,
                ...
                selectAll: function(t) {
                    ...
                    for (
                        var n = this._groups, e = n.length, i = [], r = [], u = 0; u < e;
                        ++u
                    )
                ...
                filter: function(t) {
                    ...
                    for (
                        ...
                        for (
                            var u, o = n[r], s = o.length, a = (i[r] = []), h = 0; h < s;
                            ++h
                        )
                ...
                sort: function(t) {
                    ...
                    t || (t = m);
                    for (
                        var e = this._groups, i = e.length, r = new Array(i), u = 0; u < i;
                        ++u
                    ) {
                        for (
                            var o, s = e[u], a = s.length, h = (r[u] = new Array(a)), c = 0; c < a;
                            ++c
                        )
                            (o = s[c]) && (h[c] = o);
                        h.sort(n);
            ...
            var Z = function() {
                ...
                Q = function(t, n) {
                    ...
                    if (e.createSVGPoint) {
                        ...
                        return (
                            (i.x = n.clientX),
                            (i.y = n.clientY), [(i = i.matrixTransform(t.getScreenCTM().inverse())).x, i.y]
                        );
                    }
                    ...
                    function r(r) {
                        var a = (function(t) {
                            for (
                                ...
                                if ((i = n._.children))
                                    for (
                                        n.children = new Array((u = i.length)), r = u - 1; r >= 0;
                                        --r
                                    )
                    ...
                    function e(t, e, i, r, u) {
                        if ((o = t._squarify) && o.ratio === n)
                            for (
                                ...
                                for (
                                    a = (s = o[l]).children, h = s.value = 0, c = a.length; h < c;
                                    ++h
                                )
                                    s.value += a[h].value;
                                s.dice ?
            ...
            Bi.prototype = Ci.prototype = {
                ...
                select: function(t) {
                    ...
                    "function" != typeof t && (t = c(t));
                    for (
                        var i = this._groups, r = i.length, u = new Array(r), o = 0; o < r;
                        ++o
                    )
                        for (
                            var s,
                ...
                selectAll: function(t) {
                    ...
                    "function" != typeof t && (t = f(t));
                    for (
                        var i = this._groups, r = i.length, u = [], o = [], s = 0; s < r;
                        ++s
                    )
                ...
                tween: function(t, n) {
                    ...
                    if (((t += ""), arguments.length < 2)) {
                        for (
                            var i, r = mi(this.node(), e).tween, u = 0, o = r.length; u < o;
                            ++u
                        )
                            ...
                            function(t, n, e) {
                                ...
                                return function() {
                                    ...
                                    if (o !== i) {
                                        r = (i = o).slice();
                                        for (
                                            var s = { name: n, value: e }, a = 0, h = r.length; a < h;
                                            ++a
                                        )
                                            if (r[a].name === n) {
                                                r[a] = s;
            ...
            function lr(t) {
                ...
                function o() {
                    ...
                    if (
                        (u || (u = o = Qi()),
                            t(
                                u, +i.apply(this, ((s[0] = a), s)), +r.apply(this, s), +i.apply(this, ((s[0] = h), s)), +r.apply(this, s)
                            ),
                            o)
                    )
            ...
            function jr(t) {
                ...
                for (
                    r[i - 1] = 2, u[i - 1] = 7, o[i - 1] = 8 * t[i - 1] + t[i], n = 1; n < i;
                    ++n
                )
            ...
            var Rr = (function(t) {
                    ...
                    return t;
                        ...
                        selectAll: function(t) {
                            return "string" == typeof t ?
                                new V(
                                    [document.querySelectorAll(t)], [document.documentElement]
                                ) :
                                new V([null == t ? [] : t], L);
                        },
                        get event() {
            ...
            (fu.prototype.config = function(t) {
                ...
                for (var s in this.__proto__)
                    0 === s.indexOf("_") || ["config", "constructor", "render"].includes(s) ||
                    (o[s] = this[s]());
                return o;
            }),
                                    ...
                                    this._data.reduce(function(t, i, r) {
                                        ...
                                        var o,
                                            ...
                                            ((a = n._padding(i, r)),
                                                ...
                                                2 === h.length ?
                                                (h = h.concat(h)) :
                                                3 === h.length && h.push(h[1]), ["top", "right", "bottom", "left"].reduce(function(
                                                    t,
                                                    n,
                                                    e
                                                ) {
                    ...
                    (e = [{
                            ...
                            value: function(t) {
                                ...
                                return (function t(n, e, i) {
                                    ...
                                    if (!u) {
                                        ...
                                        try {
                                            for (
                                                var h, c = r[Symbol.iterator](); !(o = (h = c.next()).done) && !(u = t(h.value, e, i)); o = !0
                                            );
                                        } catch (t) {
                                            (s = !0), (a = t);
                                        } finally {
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return (
                                    ...
                                    "nodesize" === e ?
                                    (this.getTreeGenerator().nodeSize(this._getNodeSize()), !1 === this.getAllowFocus() && (n = !0)) :
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var t = this;
                                for (
                                    this.validateSettings(), this.regenerateNodeData(); this.getElement().firstChild;
                                ...
                                return (
                                    ...
                                    this.getSvg().call(this.getZoomListener()), !1 === this.getAllowPan() &&
                                    this.getSvg()
                                    .on("mousedown.zoom", null)
                                    .on("touchstart.zoom", null)
                                    .on("touchmove.zoom", null)
                                    .on("touchend.zoom", null), !1 === this.getAllowZoom() &&
                                    this.getSvg()
                        ...
                        },
                        {
                            key: "_onNodeClick",
                            value: function(t, n, e) {
                                return (!1 !== this.emit("nodeClick", t, n, e) &&
                                    (this.getAllowFocus() ?
                                        this.nodeFocus.call(this, t) :
                                        this.nodeToggle.call(this, t), !0)
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(t, n) {
                                ...
                                return (
                                    this.removeSelection(this.getRoot()),
                                    (t.selected = !0),
                                    this.update(t), !0 !== this.getAllowNodeCentering() ||
                                    (!1 !== i && void 0 !== i) ||
                                    this.centerNode(t),
                                    this
                                );
                        ...
                        },
                        {
                            ...
                            value: function(t, n) {
                                ...
                                return (
                                    ...
                                    this.expand(t),
                                    this.update(t), !0 === this.getAllowNodeCentering() && this.centerNode(t),
                                    this
                                );
                            },
                        },
                                        ...
                                        qu(
                                            (function t(n, e) {
                                                ...
                                                if (r) {
                                                    ...
                                                    try {
                                                        for (
                                                            var a, h = r[Symbol.iterator](); !(u = (a = h.next()).done); u = !0
                                                        ) {
                                                            var c = a.value;
                                                            i.push(c);
                                                            var l = t(c, e);
            ...
            Iu.defaults = {
                ...
                getParentId: null,
                getChildren: null,
                widthWithoutMargin: 1200,
                heightWithoutMargin: 200,
                ...
                return (
                    ...
                    (i = [{
                                    ...
                                    h.each(function(t, n, o) {
                                        ...
                                        new Fu()
                                            ...
                                            .ellipsis(function(n, i) {
                                                return (
                                                    a.append("title").text(e.getBodyDisplayText(t)),
                                                    n.replace(/\.|,$/g, "") + "..."
                                                );
                                            })
                                            .render();
                        ...
                        },
                        {
                            ...
                            value: function() {
                                if (
                                    (no(eo(n.prototype), "validateSettings", this).call(this), !this._getBodyDisplayText)
                                )
                ...
                return (
                    ...
                    (i = [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                if (
                                    (yo(go(n.prototype), "validateSettings", this).call(this), !this.getDisplayText)
                                )
