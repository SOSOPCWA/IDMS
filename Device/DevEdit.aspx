    ...
    <body bgcolor="LightGray">
        <form id="form1" runat="server">
                ...
                <asp:Table ID="Table1" runat="server" Width="100%" GridLines="Both">
                    <asp:TableRow ID="rowTitle" runat="server" Font-Bold="True" ForeColor="#800000">
                        ...
                        <asp:TableCell runat="server">
                            設定 (
                            <asp:LinkButton ID="LinkHideHelp" runat="server" Font-Size="Small" ForeColor="Blue" OnClick="LinkHideHelp_Click" ToolTip="隱藏右方說明欄位，以簡化操作介面">隱藏說明</asp:LinkButton>)
                        </asp:TableCell>
                    ...
                    <asp:TableRow ID="rowDevNo" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:TextBox ID="TextDevNo" runat="server" BackColor="Silver" Columns="2" Font-Size="Large" ForeColor="Red" ReadOnly="True" CssClass="style1"></asp:TextBox>
                            &nbsp;&nbsp;
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowDevType" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:DropDownList ID="SelDevType" runat="server" AutoPostBack="True" ForeColor="#009933" DataSourceID="SqlDataSource13" DataTextField="Item" DataValueField="Item">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE [Kind] = '設備型態' ORDER BY [mark]">
                            </asp:SqlDataSource>
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowDevKind" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:DropDownList ID="SelDevKind" runat="server" AutoPostBack="True" ForeColor="#009933" DataSourceID="SqlDataSource3" DataTextField="Item" DataValueField="Item">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE ([Kind] = @設備型態) ORDER BY [mark]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="SelDevType" DefaultValue="系統設備" Name="設備型態" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowDevName" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextDevName" ErrorMessage="未輸入設備名稱" Font-Size="Small" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowPropNo" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            A(11)：
                            <asp:TextBox ID="TextPropNoA" runat="server" Columns="12" MaxLength="11" ForeColor="Green"></asp:TextBox> &nbsp;&nbsp; B(9 or 10)：
                            <asp:TextBox ID="TextPropNoB" runat="server" Columns="12" MaxLength="10" ForeColor="Green"></asp:TextBox> &nbsp;&nbsp;
                            <span><font color="blue" style="cursor:pointer" onclick="TextPropNoA.value='00000000000'"><u>不列管</u></font></span>&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkPropIn" runat="server" onclick="LinkPropIn_Click">查詢</asp:LinkButton> <br /><br /> 財產名稱：
                            <asp:Label ID="lblProp" runat="server"></asp:Label> <br /> 財產附屬：
                            <asp:Label ID="lblSpec" runat="server" Font-Size="Small"></asp:Label> <br /> 數量單位：
                            <asp:Label ID="lblAmounts" runat="server"></asp:Label> <br /> 價值　　：
                            <asp:Label ID="lblPrice" runat="server"></asp:Label> <br /> 購買日期：
                            <asp:Label ID="lblBuyDate" runat="server"></asp:Label> <br /> 使用年限：
                            <asp:Label ID="lblUseLife" runat="server"></asp:Label> <br />
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowBrand" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:Label ID="Label4" runat="server" ForeColor="Red" Font-Bold="True" Text="請保持空白，除非需要！"></asp:Label> &nbsp;&nbsp; 秘總：
                    ...
                    <asp:TableRow ID="rowStyle" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="Red" Font-Bold="True" Text="請保持空白，除非需要！"></asp:Label> &nbsp;&nbsp; 秘總：
                    ...
                    <asp:TableRow ID="rowKeeper" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            設備保管：
                            <asp:TextBox ID="TextKeeper" runat="server" Columns="6" ForeColor="Green"></asp:TextBox> &nbsp;&nbsp;
                            ...
                            &nbsp;&nbsp;
                            <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [課別] from View_課別 order by [代號]">
                                <SelectParameters>
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:DropDownList ID="SelKeeper" runat="server" ForeColor="#009933" DataSourceID="SqlDataSource11" OnSelectedIndexChanged="SelKeeper_SelectedIndexChanged" AutoPostBack="true" DataTextField="Item" DataValueField="Item">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE ([Kind] = @Kind) and [Config]<>'測試' ORDER BY [mark]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="SelKeeperUnit" Name="Kind" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource> &nbsp;&nbsp;
                            <asp:LinkButton ID="LinkKeeperClear" runat="server" onclick="LinkKeeperClear_Click">空白</asp:LinkButton>&nbsp;&nbsp;
                            <asp:Label ID="Label7" runat="server" ForeColor="Red" Font-Bold="True" Text="請保持空白，除非需要！"></asp:Label> <br /><br /> 財產保管：
                            <asp:Label ID="lblKeeper" runat="server"></asp:Label> <br /><br /> 使用人員：
                    ...
                    <asp:TableRow ID="rowDevStatus" runat="server" HorizontalAlign="Left">
                        ...
                        <asp:TableCell ID="TableCell2" runat="server" Font-Size="Small">
                            <asp:DropDownList ID="SelDevStatus" runat="server" ForeColor="#009933" DataSourceID="SqlDataSourceDevStatus" DataTextField="Item" DataValueField="Item">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceDevStatus" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE [Kind] = '設備狀態' ORDER BY [mark]">
                            </asp:SqlDataSource>&nbsp;&nbsp; 秘總：
                    ...
                    <asp:TableRow ID="rowPlace" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:DropDownList ID="SelPlace" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SelPointer_SelectedIndexChanged" ForeColor="#009933" DataSourceID="SqlDataSource1" DataTextField="區域名稱" DataValueField="區域名稱">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT DISTINCT [區域名稱] FROM [定位設定] WHERE ([定位方式] &lt;&gt; @定位方式) order by [區域名稱]">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="坐標" Name="定位方式" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            &nbsp;
                            <asp:DropDownList ID="SelPointer" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SelPointer_SelectedIndexChanged" ForeColor="#009933" DataSourceID="SqlDataSource2" DataTextField="定位名稱" DataValueField="定位編號">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [定位編號],[定位名稱] FROM [定位設定] WHERE (([定位方式] &lt;&gt; @定位方式) AND ([區域名稱] = @區域名稱)) order by [定位名稱]">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="坐標" Name="定位方式" Type="String" />
                        ...
                        &nbsp; &nbsp; 或 &nbsp; &nbsp;<font style="cursor: pointer; font-size: Small; color: Blue"><u>坐標定位</u></font>
                            ...
                            <asp:TextBox ID="TextPointerNo" runat="server" BackColor="Silver" Columns="4" onfocus="this.blur();"></asp:TextBox>
                            <br /><br /> 機櫃高度：
                            <asp:DropDownList ID="SelRU" runat="server" ForeColor="#009933"></asp:DropDownList> (低) &nbsp;&nbsp;&nbsp;&nbsp; 空間大小：
                            <asp:DropDownList ID="SelSpace" runat="server" ForeColor="#009933"></asp:DropDownList> (U)
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowSource" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            &nbsp;&nbsp;
                            <asp:DropDownList ID="SelSource" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SelSource_SelectedIndexChanged" DataSourceID="SqlDataSource12" DataTextField="取得來源" DataValueField="取得來源" ForeColor="#009933">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT DISTINCT [取得來源] FROM [實體設備] WHERE ([設備型態] = @設備型態) order by [取得來源]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="SelDevType" DefaultValue="系統設備" Name="設備型態" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <asp:TableRow ID="rowHostName" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextHostName" ErrorMessage="未輸入主機名稱" Font-Size="Small" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowIP" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <br /><br /> 監控IP：
                            <asp:TextBox ID="TextMosIP" runat="server" ForeColor="Green"></asp:TextBox> (單筆)&nbsp;
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ErrorMessage="IP輸入格式有誤" ValidationExpression="\b(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\b" ControlToValidate="TextMosIP"
                    ...
                    <asp:TableRow ID="rowVoltage" runat="server" HorizontalAlign="Left">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:TextBox ID="TextVoltage" runat="server" Columns="6" MaxLength="4" ForeColor="Green" OnKeyDown="if(event.keyCode <=57 | event.keyCode >=96 & event.keyCode <=105) {event.returnValue=true;} else{event.returnValue=false;}"> </asp:TextBox>
                            <span class="style2">(伏特)</span>
                            <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="TextVoltage" Display="Dynamic" ErrorMessage="用電電壓輸入有誤" Font-Size="Small" MaximumValue="1000" MinimumValue="0" SetFocusOnError="True" Type="Integer">
                            </asp:RangeValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextVoltage" ErrorMessage="未輸入用電電壓" Font-Size="Small" SetFocusOnError="True" Display="Dynamic">
                    ...
                    <asp:TableRow ID="rowSpecCurrent" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <asp:TextBox ID="TextSpecCurrent" runat="server" Columns="6" MaxLength="6" ForeColor="Green" OnKeyDown="if(event.keyCode <=57 | event.keyCode >=96 & event.keyCode <=105 | event.keyCode ==110 | event.keyCode ==190) {event.returnValue=true;} else{event.returnValue=false;}"></asp:TextBox>
                            <span class="style2">(安培)</span>
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextSpecCurrent" Display="Dynamic" ErrorMessage="額定電流輸入有誤" Font-Size="Small" MaximumValue="1500.0" MinimumValue="0.0" SetFocusOnError="True" Type="Double">
                            </asp:RangeValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextSpecCurrent" ErrorMessage="未輸入額定電流" Font-Size="Small" SetFocusOnError="True" Display="Dynamic">
                            </asp:RequiredFieldValidator>
                        </asp:TableCell>
                        <asp:TableCell runat="server" Font-Size="Small">
                    ...
                    <asp:TableRow ID="rowConn" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="BtnDevTree" runat="server" Text=" 設 定 " CausesValidation="False" OnClick="BtnDevTree_Click" />&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td>
                                        上游供電：
                                        <asp:Label ID="lblUpPower" runat="server" Font-Size="Small"></asp:Label>
                                        <br /> 下游用電：
                                        <asp:Label ID="lblDnPower" runat="server" Font-Size="Small"></asp:Label>
                                        <br /> 上游供網：
                                        <asp:Label ID="lblUpNet" runat="server" Font-Size="Small"></asp:Label>
                                        <br /> 下游用網：
                                        <asp:Label ID="lblDnNet" runat="server" Font-Size="Small"></asp:Label>
                                        <br /> 上游供冷：
                                        <asp:Label ID="lblUpCold" runat="server" Font-Size="Small"></asp:Label>
                                        <br /> 下游用冷：
                                        <asp:Label ID="lblDnCold" runat="server" Font-Size="Small"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </asp:TableCell>
                    ...
                    <asp:TableRow ID="rowRepair" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            &nbsp;&nbsp;
                            <asp:DropDownList ID="SelRepair" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SelRepair_SelectedIndexChanged" ForeColor="#009933" DataSourceID="SqlDataSourceRepair" DataTextField="維護廠商" DataValueField="維護廠商">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceRepair" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT DISTINCT [維護廠商] FROM [實體設備] WHERE ([設備型態] = @設備型態)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="SelDevType" DefaultValue="系統設備" Name="設備型態" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <asp:TableRow ID="rowMaintainor" runat="server" HorizontalAlign="Left" VerticalAlign="Middle">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE ([Kind] = @Kind) and [Config]<>'測試' ORDER BY [mark]">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="SelHwUnit" Name="Kind" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <br />
                            <br />
                            ...
                            &nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="SelMaintainor" ErrorMessage="未選擇維護人員" Font-Size="Small" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                            <br />
                            <br />
                    ...
                    <asp:TableRow ID="rowPowerOff" runat="server" HorizontalAlign="Left">
                        ...
                        <asp:TableCell runat="server" Font-Size="Small">
                            ...
                            <asp:SqlDataSource ID="SqlDataSourcePowerOff" runat="server" ConnectionString="<%$ ConnectionStrings:IDMSConnectionString %>" SelectCommand="SELECT [Item] FROM [Config] WHERE [Kind] = '關機順序' ORDER BY [mark]">
                            </asp:SqlDataSource>&nbsp;&nbsp;
            ...
            <div class="style1">
                ...
                <asp:Button ID="BtnDel" runat="server" Text="　刪　除　" CausesValidation="False" OnClick="BtnDel_Click" OnClientClick="return confirm('請注意作業主機與接電迴路將一併刪除！若要保留，請先於作業主機介面清除本設備編號！您確定要刪除這筆資料嗎？')" />
